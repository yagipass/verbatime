...
public class OrderController {
    ...
    @GetMapping("/orders")
    public OrderEntity place(@RequestParam(defaultValue = "widget") final String sku, @RequestParam(defaultValue = "1") final int qty) {
    ...
    public ResponseEntity<OrderEntity> find(@PathVariable final long id) {
